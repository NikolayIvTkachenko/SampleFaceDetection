...
public class Detector {
    ...
    public Detector() {
        ...
        this.cascadeClassifier = new CascadeClassifier("C:\\OPENCV\\haarcascades\\haarcascade_frontalface_alt.xml");
    }   
    ...
    private void showFacesOnScreen(){
        for (Rect rect : detectedFaces.toArray()) {
            Imgproc.rectangle(coloredImage, new Point(rect.x, rect.y), new Point(
                rect.x + rect.width, rect.y + rect.height), new Scalar(100,100, 250), 10);
        }
    }    
